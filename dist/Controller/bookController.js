...
const postBook = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newBook = yield store_1.default.create({
            author,
            title,
            category,
            summary,
...
const getAllbooks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const book = yield store_1.default.find();
...
const getOneBook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const getOne = yield store_1.default.findById(req.params.id);
        return res.status(201).json({
...
const searchBooks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const makeSearch = yield store_1.default.find(queryData);
...
const myViews = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newView = yield store_1.default.findByIdAndUpdate(req.params.id, {
